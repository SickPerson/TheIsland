...
namespace Vector3
{
	...
	inline XMFLOAT3 Multiply(XMFLOAT3& xmf3Vector, XMFLOAT3& xmf4Vector)
	{
		XMFLOAT3 xmf4Result;
		XMStoreFloat3(&xmf4Result, XMLoadFloat3(&xmf3Vector) * XMLoadFloat3(&xmf4Vector));
		return(xmf4Result);
	}
	
	inline bool ObjectRangeCheck(XMFLOAT3& xmf3Player, XMFLOAT3& xmf3Object, float fDistance)
	{
		return  Vector3::Length(Vector3::Subtract(xmf3Player, xmf3Object)) <= fDistance;
	}
	inline bool ObjectRangeCheck(XMFLOAT3& xmf3Player, XMFLOAT3& xmf3Object, float fMin, float fMax)
	{
		float fResult = Vector3::Length(Vector3::Subtract(xmf3Player, xmf3Object));
		return (fResult <= fMax && fResult >= fMin);
	}
}
